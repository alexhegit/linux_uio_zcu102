...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pl_irq_ef [ create_bd_port -dir I -type intr pl_irq_ef ]
  set_property -dict [ list \
CONFIG.SENSITIVITY {EDGE_FALLING} \
 ] $pl_irq_ef
  set pl_irq_er [ create_bd_port -dir I -type intr pl_irq_er ]
  set_property -dict [ list \
CONFIG.SENSITIVITY {EDGE_RISING} \
 ] $pl_irq_er
  set pl_irq_lh [ create_bd_port -dir I -type intr pl_irq_lh ]
  set pl_irq_ll [ create_bd_port -dir I -type intr pl_irq_ll ]
  set_property -dict [ list \
...
CONFIG.PSU__USE__M_AXI_GP2 {0} \
  ...
  connect_bd_net -net axi_gpio_1_ip2intc_irpt [get_bd_pins axi_gpio_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In4]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
